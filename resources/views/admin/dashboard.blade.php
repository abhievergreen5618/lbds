    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          ...
          <a href="{{route('admin.request.list',['status'=>'pending'])}}" class="small-box-footer text-center">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
          ...
          <a href="{{route('admin.request.list',['status'=>'assigned'])}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-primary">
          ...
          <a href="{{route('admin.request.list',['status'=>'underreview'])}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
       ...
       <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          ...
          <a href="{{route('admin.request.list',['status'=>'completed'])}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
       <!-- ./col -->
    </div>
