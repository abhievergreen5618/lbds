...
class OptionsSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = [
            ...
            ["option_name"=>"mail_host","option_value"=>"mail.windmitigationportal.com"],
            ["option_name"=>"mail_port","option_value"=>"465"],
            ["option_name"=>"mail_username","option_value"=>"support@windmitigationportal.com"],
            ["option_name"=>"mail_password","option_value"=>"Windmit2022*"],
            ["option_name"=>"mail_from_address","option_value"=>"support@windmitigationportal.com"],
            ["option_name"=>"mail_encryption","option_value"=>"ssl"],
            ...
            ["option_name"=>"applicant_request_assign_message","option_value"=>"<p>Hi [first_name],</p><p>Your [applicant_name] Request has been Successfully Assigned to [inspector_name].</p>"],
            ...
            ["option_name"=>"applicant_request_scheduled_message","option_value"=>"<p>Hi [first_name],</p><p>Your [applicant_name] Request has been Successfully Scheduled on [inspection_date] at [inspection_time]</p><p>Inspector name -: [inspector_name]</p><p>Company name -: [company_name]</p><p>Company location -:&nbsp;[company_location]</p>"],
            ...
            ["option_name"=>"applicant_request_underreview_message","option_value"=>"<p>Hi [first_name],</p><p>Your Request has been Successfully Reviewed By [inspector_name].</p>"],
            ...
            ["option_name"=>"applicant_request_completed_message","option_value"=>"<p>Hi [first_name],</p><p>Your Inspestion Request has been Successfully Completed.</p>"],
