...
class OptionsSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = [
            ...
            ["option_name"=>"inspectorrequestreminderemail_message","option_value"=>"<p>Hi [inspector_name],</p><p>Reminder for an inspection with [company_name] on [inspection_date] at [inspection_time].<p>Company Location -: [company_location]</p><p>Applicant Name -: [applicant_name]</p><p>Applicant Email -: [applicant_email]</p><p>Applicant Address -: [applicant_address]</p><p>Applicant Phone -: [applicant_phone]</p>"],
            ["option_name"=>"companyrequestreminderemail_message","option_value"=>"<p>Hi [company_name],</p><p>As a reminder, your inspection is booked for [inspection_date] at [inspection_time]. <p>Inspector name -: [inspector_name]</p><p>Company name -: [company_name]</p><p>Company location -: [company_location]</p><p>Applicant Name -: [applicant_name]</p><p>Applicant Email -: [applicant_email]</p><p>Applicant Address -: [applicant_address]</p><p>Applicant Phone -: [applicant_phone]</p>"]
        ];
