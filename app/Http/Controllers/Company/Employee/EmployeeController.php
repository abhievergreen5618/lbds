...
class EmployeeController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return  redirect()->route('company.employee.view')->with("msg", "Record Created Successfully");
    }
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)->addIndexColumn()
                ->addColumn('action', function ($row) {
                    $id = encrypt($row->id);
                    $editlink = route('company.show.employee', ['id' => $id]);
...
//
    ...
    public function submitUpdate(Request $request)
    {
        if(isset($request['id']) && !empty($request['id']))
        {
            ...
            return redirect()->route('company.employee.view')->with("msg","Record Updated Successfully");
        }
