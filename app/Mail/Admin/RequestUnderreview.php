...
class RequestUnderreview extends Mailable
{
    ...
    public function __construct($insdetails,$companydetails,$requestdetails,$subject,$type)
    {
        ...
        {
            $this->body = $options->get_option('inspector_request_underreview_message');
        }
        else if($type=='companyassign')
        {
            $this->body = $options->get_option('company_request_underreview_message');
        }
        else if($type=='applicantassign')
        {
            $this->body = $options->get_option('applicant_request_underreview_message');
        }
        if($type=='inspectorassign')
        {
