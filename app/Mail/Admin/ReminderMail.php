...
class ReminderMail extends Mailable
{
    ...
    public function __construct($insdetails,$companydetails,$requestdetails,$senduser)
    {
        ...
        $this->body= str_replace('[applicant_address]',$requestdetails['address'],$this->body);
        $this->body= str_replace('[applicant_phone]',$requestdetails['applicantmobile'],$this->body);
    }
